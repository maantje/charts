...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
  ...
  <text x="233.75" y="580" font-family="arial" font-size="14" fill="black" stroke="none" stroke-width="0" text-anchor="middle" dominant-baseline="alphabetic" alignment-baseline="auto">January</text>
  <rect x="541.25" y="250" width="100" height="300" fill="green" fill-opacity="1" stroke="none" stroke-width="0" rx="0" ry="0">
    <title>40</title>
  </rect>
  <text x="591.25" y="540" font-family="arial" font-size="14" fill="white" stroke="none" stroke-width="0" text-anchor="middle" dominant-baseline="alphabetic" alignment-baseline="auto">57%</text>
  <rect x="541.25" y="25" width="100" height="225" fill="red" fill-opacity="1" stroke="none" stroke-width="0" rx="0" ry="0">
    <title>30</title>
  </rect>
  <text x="591.25" y="240" font-family="arial" font-size="14" fill="white" stroke="none" stroke-width="0" text-anchor="middle" dominant-baseline="alphabetic" alignment-baseline="auto">43%</text>
  <text x="591.25" y="580" font-family="arial" font-size="14" fill="black" stroke="none" stroke-width="0" text-anchor="middle" dominant-baseline="alphabetic" alignment-baseline="auto">February</text>
</svg>
SVG);
});
...
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
  ...
  <text x="410" y="580" font-family="arial" font-size="14" fill="black" stroke="none" stroke-width="0" text-anchor="middle" dominant-baseline="alphabetic" alignment-baseline="auto">January</text>
</svg>
SVG);
});
