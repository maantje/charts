...
<div class="section">
    <h3>Negative Values Chart</h3>
    <div class="chart">{$negativeChart->render()}</div>
    <p>Description: A mixed chart demonstrating how to handle negative values in both line and bar charts.</p>
</div>
